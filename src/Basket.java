...
public class Basket {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    searchByCost(collection, Keyboard);
                    break;
                case 5:
    ...
    public static void inputItem(BasketballItemCollection collection, Scanner Keyboard) {
        ...
        System.out.print("Enter the item's rating like 1-5 how important it is: ");
    ...
    public static void removeItem(BasketballItemCollection collection, Scanner Keyboard) {
    ...
    public static void searchItems(BasketballItemCollection collection, Scanner Keyboard) {
        System.out.print("Enter a search phrase: ");
        String searchPhrase = Keyboard.nextLine();
        collection.search(searchPhrase);
    }

    public static void searchByCost(BasketballItemCollection collection, Scanner Keyboard) {
        System.out.print("Enter a search phrase: ");
        String searchByCost = Keyboard.nextLine();
        collection.search(searchByCost);
    }
}
